<template>
  ...
  <n-grid id="charts" v-if="dashboard.charts && dashboard.charts.length > 0" cols="1 640:12" x-gap="12" y-gap="12">
...
function showDlg() {
  ...
  chartApi.search({ dashboard: props.type, page: 1, size: 100 }).then(r => {
