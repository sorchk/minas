...
function initState(): State {
    ...
    return {
        user: {id:user.id, username: user.username,avatar: user.avatar, ip: user.ip, perms: new Set(user.perms), name: user.name, token: user.token },
...
export const store = createStore<State>({
    ...
    mutations: {
        ...
        [Mutations.SetUser](state, user) {
            ...
            state.user = { id: user.id, username: user.username, avatar: user.avatar, ip: user.ip,perms: new Set(user.perms), name: user.name, token: user.token };
        },
